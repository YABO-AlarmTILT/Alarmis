...
public class ObjectFactory {
    ...
    private final static String _AdressWS = "com.alarmtilt.webservice.soap.res.v3";
    
    private final static QName _RequestSubscriptionResponse_QNAME = new QName(_AdressWS, "requestSubscriptionResponse");
    private final static QName _ImportAgenda_QNAME = new QName(_AdressWS, "importAgenda");
    private final static QName _ListContactAttribute_QNAME = new QName(_AdressWS, "listContactAttribute");
    private final static QName _ListManagementUnitResponse_QNAME = new QName(_AdressWS, "listManagementUnitResponse");
    private final static QName _ListContact_QNAME = new QName(_AdressWS, "listContact");
    private final static QName _ListSubscription_QNAME = new QName(_AdressWS, "listSubscription");
    private final static QName _ListContactUser_QNAME = new QName(_AdressWS, "listContactUser");
    private final static QName _PingServiceResponse_QNAME = new QName(_AdressWS, "pingServiceResponse");
    private final static QName _ListCmcInstanceResponse_QNAME = new QName(_AdressWS, "listCmcInstanceResponse");
    private final static QName _ListContactUserResponse_QNAME = new QName(_AdressWS, "listContactUserResponse");
    private final static QName _ImportAgendaResponse_QNAME = new QName(_AdressWS, "importAgendaResponse");
    private final static QName _LaunchProcedure_QNAME = new QName(_AdressWS, "launchProcedure");
    private final static QName _SendNotificationResponse_QNAME = new QName(_AdressWS, "sendNotificationResponse");
    private final static QName _CreateContactUser_QNAME = new QName(_AdressWS, "createContactUser");
    private final static QName _ListContactResponse_QNAME = new QName(_AdressWS, "listContactResponse");
    private final static QName _CreateContactUserResponse_QNAME = new QName(_AdressWS, "createContactUserResponse");
    private final static QName _DeleteContactUser_QNAME = new QName(_AdressWS, "deleteContactUser");
    private final static QName _LaunchCmcResponse_QNAME = new QName(_AdressWS, "launchCmcResponse");
    private final static QName _ListCmcDefinition_QNAME = new QName(_AdressWS, "listCmcDefinition");
    private final static QName _ListManagementUnit_QNAME = new QName(_AdressWS, "listManagementUnit");
    private final static QName _ExportAgendaResponse_QNAME = new QName(_AdressWS, "exportAgendaResponse");
    private final static QName _ListCmcInstance_QNAME = new QName(_AdressWS, "listCmcInstance");
    private final static QName _ListSubscriptionResponse_QNAME = new QName(_AdressWS, "listSubscriptionResponse");
    private final static QName _GetContactUserResponse_QNAME = new QName(_AdressWS, "getContactUserResponse");
    private final static QName _ValidateSubscriptionResponse_QNAME = new QName(_AdressWS, "validateSubscriptionResponse");
    private final static QName _ValidateSubscription_QNAME = new QName(_AdressWS, "validateSubscription");
    private final static QName _GetContactUser_QNAME = new QName(_AdressWS, "getContactUser");
    private final static QName _ExportAgenda_QNAME = new QName(_AdressWS, "exportAgenda");
    private final static QName _SendNotification_QNAME = new QName(_AdressWS, "sendNotification");
    private final static QName _UpdateContactUserResponse_QNAME = new QName(_AdressWS, "updateContactUserResponse");
    private final static QName _RequestSubscription_QNAME = new QName(_AdressWS, "requestSubscription");
    private final static QName _PingService_QNAME = new QName(_AdressWS, "pingService");
    private final static QName _ListCmcDefinitionResponse_QNAME = new QName(_AdressWS, "listCmcDefinitionResponse");
    private final static QName _UpdateContactUser_QNAME = new QName(_AdressWS, "updateContactUser");
    private final static QName _ListContactAttributeResponse_QNAME = new QName(_AdressWS, "listContactAttributeResponse");
    private final static QName _DeleteContactUserResponse_QNAME = new QName(_AdressWS, "deleteContactUserResponse");
    private final static QName _LaunchProcedureResponse_QNAME = new QName(_AdressWS, "launchProcedureResponse");
    private final static QName _LaunchCmc_QNAME = new QName(_AdressWS, "launchCmc");
